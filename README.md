...
### Nowe Narzędzie: Motywator Pro 🚀
W ramach rozwoju sekcji narzędziowej (użyteczność), do systemu dodany został **Motywator Pro** - zaawansowany tracker nawyków.
- Lokalizacja: `/` (Główna strona aplikacji motywacyjnej)
- Funkcje: Śledzenie 5 nawyków (Bieganie, Oddechy, Papierixy, Trwa, Koń) w widoku kalendarza (Marzec 2026).
- System punktowy: Zlicza dni bez relapsu.
- Design: Modern Dark Mode z neonowymi akcentami.
